    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-light">
        ...
        <div class="navbar-collapse">
            ...
            <ul class="navbar-nav my-lg-0">
                ...
                <!-- ============================================================== -->
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{asset('assets/images/mjb2.png')}}" alt="user" class="profile-pic" /></a>
                    <div class="dropdown-menu dropdown-menu-right scale-up">
                        <ul class="dropdown-user">
                            <li>
                                <div class="dw-user-box">
                                    <div class="u-img"><img src="{{asset('assets/images/mjb2.png')}}" alt="user"></div>
                                    <div class="u-text">
                                        <h4>Steave Jobs</h4>
...
{{--<aside class="left-sidebar">--}}
    ...
    {{--    <div class="scroll-sidebar">--}}
        ...
        {{--        <div class="user-profile">--}}
            {{--            <!-- User profile image -->--}}
            {{--            <div class="profile-img"> <img src="{{asset('assets/images/mjb1.jfif')}}" alt="user" />--}}
            ...
            {{--            <ul id="sidebarnav">--}}
                ...
                {{--                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">Project Update</span></a>--}}
                    {{--                    <ul aria-expanded="false" class="collapse">--}}
                        {{--                        <li><a href="#">All Project Update </a></li>--}}
                        {{--                        <li><a href="#">Add Project Update</a></li>--}}
                        {{--                    </ul>--}}
                    {{--                </li>--}}
                {{--                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">Events</span></a>--}}
                    {{--                    <ul aria-expanded="false" class="collapse">--}}
                        {{--                        <li><a href="#">All Events</a></li>--}}
                        {{--                        <li><a href="#">add Events</a></li>--}}
                        {{--                        <li><a href="#">add Events Image</a></li>--}}

                        {{--                    </ul>--}}
                    {{--                </li>--}}
                {{--                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">CSR Details</span></a>--}}
                    {{--                    <ul aria-expanded="false" class="collapse">--}}
                        {{--                        <li><a href="#">All CSR Details</a></li>--}}
                        {{--                        <li><a href="#">Add CSR Details</a></li>--}}
                        {{--                        <li><a href="#">Add CSR Image</a></li>--}}
                        {{--                    </ul>--}}
                    {{--                </li>--}}
