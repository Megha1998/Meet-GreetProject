                        ...
                        <div class="widget-content">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" onchange="getSelectValue();">
                                    ...
                                    <tbody>
                                    @foreach($errors as $career )
                                        <tr>
                                            <td>{{$career->id}}</td>
                                            <td>{{$career->designation}}</td>
                                            <td>{{$career->vacancies}}</td>
                                            <td class="td-actions"><a href="{{route('/')}}" target="_blank" class="btn btn-small btn-primary" type="button" id="">Apply Now<a href="{{route('pages.apply')}}"></a>
                                                </a></td>
                                        </tr>
                                    @endforeach
                                    {{--                                    <tr><td>2</td>--}}
