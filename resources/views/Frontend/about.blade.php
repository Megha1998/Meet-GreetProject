            ...
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-9">
                    <div class="mb-5 pb-4">
                        ...
                        <p class="mb-0 text-justify">We are here to integrate all of us together. We are here to bring forward all the food places in the city.
                            <br>
                            The services of Greet & Meet goes ahead with providing carrers page for the vacancies avaivable around the food places which includes the hotels, the resturants, the cafes, and mostl the indie cafes.It provides with the latest vacancies present in the food places.
                            It provides the latest events that's taking place around the city. </p>
                    </div>
                </div>
                <!--End row-->
            </div>
